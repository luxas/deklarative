...
func WithContentLength(length int64) HeaderOption {
	return SetOption(ContentLengthKey, strconv.FormatInt(length, 10))
}
...
func GetBytes(m Header, key string) ([]byte, bool) {
